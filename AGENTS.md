...
There are exceptions to this rule, agents may specifically edit files under `./design/` including `solidified_features.md` for example dumping language design information into `language_design_seed.md`
